<form method="post">
    ...
    <p>
        <!-- <input type="submit" name="doSave" value="Create"><i class="fa fa-floppy-o" aria-hidden="true"></i> -->
        <button type="submit" name="doSave"><i class="fa fa-floppy-o" aria-hidden="true"></i> Create</button>
